...
class agent_population(object):
    ...
    def fitness_shape(self, fitnesses, max_fail_score):
    ...
    def pass_fitnesses(self, fitnesses, max_fail_score, fitness_shaping=True):
        if fitness_shaping:
            processed_fitnesses = self.fitness_shape(fitnesses, max_fail_score)
        else:
